...
import { LayoutDashboard, Brackets as Racket, Calendar, DollarSign, Menu, X, LogOut } from 'lucide-react';
        ...
        <div className="h-full flex flex-col">
          <div className="flex items-center justify-between px-4 h-16 border-b border-gray-200">
            <div className="flex items-center">
              ...
              <h1 className="ml-2 text-xl font-bold text-[var(--primary)]">Admin</h1>
            </div>
            <button
